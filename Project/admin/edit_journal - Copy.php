...
<section class="post-editor">
   ...
   <h1 class="heading">edit journal</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="title" maxlength="100" required placeholder="add journal title" class="box" value="<?= $fetch_posts['title']; ?>">
      <p>journal content <span>*</span></p>
      ...
      <p>journal category <span>*</span></p>
      ...
      <div class="flex-btn">
         ...
         <a href="view_journals.php" class="option-btn">go back</a>
   ...
   <?php
         ...
         echo '<p class="empty">no journals found!</p>';
   ?>
   <div class="flex-btn">
      <a href="view_journals.php" class="option-btn">view journals</a>
      <a href="add_journals.php" class="option-btn">add journals</a>
   </div>
   <?php
      }
   ?>
