...
<section class="post-editor">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input  type="text" name="title" maxlength="100" required placeholder="add journal title" class="box">
      ...
      <div class="flex-btn">
         <input type="submit" value="publish journal" name="publish" class="btn">
