...
<section class="show-posts">
   ...
   <h1 class="heading">your journals</h1>
   ...
   <div class="box-container">
      ...
      <form method="post" class="box">
         ...
         <div class="flex-btn">
            <a href="edit_journals.php?id=<?= $post_id; ?>" class="option-btn">edit</a>
            <button type="submit" name="delete" class="delete-btn" onclick="return confirm('delete this post?');">delete</button>
         </div>
         <a href="read_journals.php?post_id=<?= $post_id; ?>" class="btn">view journals</a>
      </form>
      <?php
            }
         }else{
            echo '<p class="empty">no journals added yet! <a href="add_journals.php" class="btn" style="margin-top:1.5rem;">add journal</a></p>';
         }
      ?>
