...
<section class="home-grid">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>journals liked : <span><?= $total_user_likes; ?></span></p>
      ...
      <div class="box">
         ...
         ?>
            ...
            echo '<p class="empty">no journals added yet!</p>';
         }
         ?>  
...
<section class="posts-container">
   ...
   <h1 class="heading">latest journals</h1>
   ...
   <div class="box-container">
      ...
      <form class="box" method="post">
         ...
         <a href="view_journal.php?post_id=<?= $post_id; ?>" class="inline-btn">read more</a>
         <a href="category.php?category=<?= $fetch_posts['category']; ?>" class="post-cat"> <i class="fas fa-tag"></i> <span><?= $fetch_posts['category']; ?></span></a>
         <div class="icons">
            <a href="view_journal.php?post_id=<?= $post_id; ?>"><i class="fas fa-comment"></i><span>(<?= $total_post_comments; ?>)</span></a>
   ...
   <div class="more-btn" style="text-align: center; margin-top:1rem;">
      <a href="journals.php" class="inline-btn">view all journals</a>
   </div>
